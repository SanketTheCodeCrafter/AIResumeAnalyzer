...
/* ── InterviewForm ───────────────────────────────────────────
 *  Pure form component.
 *  Delegates business logic to useInterview() hook.
 *  Owns only form state (react-hook-form) and UI rendering.
 * ─────────────────────────────────────────────────────────── */

const InterviewForm = () => {
    const navigate = useNavigate();
    const { interviewState, generateReport } = useInterview();
    const { isGenerating } = interviewState;
